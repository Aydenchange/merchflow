...
import { createPrismaCatalogRepository } from "../server/catalog/prisma-repository";
...
import { createPrismaOrderRepository } from "../server/orders/prisma-repository";
import { createPrismaPaymentRepository } from "../server/payments/prisma-repository";
